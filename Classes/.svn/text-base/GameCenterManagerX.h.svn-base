...
@interface GameCenterManagerX : NSObject <NSCoding, GKLeaderboardViewControllerDelegate>
{
	// Boolean that is set to true if device supports Game Center and a player has logged in
	BOOL hasGameCenter, loggedIn;
...
SYNTHESIZE_SINGLETON_FOR_CLASS_HEADER(GameCenterManagerX);
